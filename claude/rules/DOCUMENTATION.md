...
- **Ωράρια & Άδειες** — Διαχείριση ωραρίων, αδειών, check-in validation
- **Proactive Notifications** — Υπενθύμιση βάρδιας, εγκρίσεις αδειών, εβδομαδιαία σύνοψη
...
│   │   └── 003_schedules.sql       Ωράρια, αναθέσεις, άδειες
│   ├── seeds/demo_data.sql
