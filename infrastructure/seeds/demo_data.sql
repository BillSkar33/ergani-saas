...
INSERT INTO branches (
  ...
  '0',                                             -- Κεντρικό (branch 0)
  'Κεντρικό — Σύνταγμα',
  'Πλατεία Συντάγματος, Αθήνα 105 63',
...
INSERT INTO branches (
  ...
  'Πλατεία Μοναστηρακίου, Αθήνα 105 55',
...
INSERT INTO employees (
  ...
  (SELECT id FROM employers WHERE afm_ergodoti = '000000000'),
  (SELECT id FROM branches WHERE branch_name = 'Κεντρικό — Σύνταγμα'),
...
INSERT INTO employees (
  ...
  (SELECT id FROM employers WHERE afm_ergodoti = '000000000'),
  (SELECT id FROM branches WHERE branch_name = 'Υποκατάστημα — Μοναστηράκι'),
  '333333333',
  'ΜΟΝΑΣΤΗΡΑΚΙΩΤΗΣ',
  'ΕΡΓΑΤΗΣ',
  false,
...
INSERT INTO employer_notification_settings (
  ...
  notify_on_checkin,
  notify_on_checkout,
  notify_on_geofence_violation,
  notify_on_fraud_alert,
  notify_on_ergani_failure
) VALUES (
  (SELECT id FROM employers WHERE afm_ergodoti = '000000000'),
  false,                                             -- Δεν ειδοποιεί σε κάθε check-in
  false,                                             -- Δεν ειδοποιεί σε κάθε check-out
...
SELECT 'Παράρτημα: ' || branch_name || ' (GPS: ' || latitude || ', ' || longitude || ')'
