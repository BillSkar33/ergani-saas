...
const TEMPLATES = {
    ...
    checkout_reminder_scheduled: {
        text: '⏰ Η βάρδια σου λήγει στις {{endTime}}.\n\n' +
            'Μην ξεχάσεις check-out! Στείλε τοποθεσία για ΛΗΞΗ βάρδιας.',
    },

    // --- Αυτόματες Ενέργειες ---
    auto_checkout: {
        text: '🤖 Αυτόματο check-out στις {{time}}.\n' +
            '⏱️ Διάρκεια βάρδιας: {{duration}}\n\n' +
            'Η κάρτα εργασίας σου υποβλήθηκε αυτόματα.',
    },

    auto_checkin_late: {
        text: '🤖 Αυτόματο check-in (αργοπορία {{lateMinutes}} λεπτά).\n' +
            '⏰ Καταγράφηκε έναρξη: {{time}}\n\n' +
            'Επικοινώνησε με τον εργοδότη σου αν χρειαστεί.',
    },

    overtime_warning: {
        text: '⚠️ Υπερωρία: Το check-out έγινε {{minutes}} λεπτά μετά τη λήξη βάρδιας.\n\n' +
            'Επικοινώνησε με τον εργοδότη σου για ενημέρωση.',
    },

    schedule_changed: {
        text: '📅 Αλλαγή Ωραρίου!\n\n' +
            'Νέο ωράριο: «{{scheduleName}}»\n' +
            '⏰ {{startTime}} - {{endTime}}\n\n' +
            'Επικοινώνησε με τον εργοδότη σου για λεπτομέρειες.',
    },
    ...
    // --- Proactive Ειδοποιήσεις Εργαζομένου ---
    shift_reminder: {
        text: '🔔 Υπενθύμιση, {{name}}!\n\n' +
            'Η βάρδια σου «{{scheduleName}}» ξεκινά σε 30 λεπτά.\n' +
            '⏰ {{startTime}} - {{endTime}}\n\n' +
            '📍 Στείλε τοποθεσία για check-in όταν φτάσεις.',
    },

    schedule_assigned: {
        text: '📅 Νέο Ωράριο!\n\n' +
            'Σου ανατέθηκε: «{{scheduleName}}»\n' +
            '⏰ {{startTime}} - {{endTime}}\n' +
            '📆 Ισχύει από: {{effectiveFrom}}\n\n' +
            'Θα λαμβάνεις υπενθύμιση 30\' πριν κάθε βάρδια.',
    },

    leave_approved: {
        text: '✅ Η άδεια σου εγκρίθηκε!\n\n' +
            '📋 Τύπος: {{leaveType}}\n' +
            '📆 {{startDate}} → {{endDate}}\n\n' +
            'Καλή ξεκούραση! 🏖️',
    },
    ...
    leave_rejected: {
        text: '❌ Η αίτηση άδειας σου απορρίφθηκε.\n\n' +
            '📋 Τύπος: {{leaveType}}\n' +
            '📆 {{startDate}} → {{endDate}}\n\n' +
            'Επικοινώνησε με τον εργοδότη σου για λεπτομέρειες.',
    },
    ...
    weekly_employee_summary: {
        text: '📊 Εβδομαδιαία Σύνοψη, {{name}}!\n\n' +
            '📅 {{weekStart}} → {{weekEnd}}\n' +
            '✅ Βάρδιες: {{shifts}}\n' +
            (data => data?.openShifts > 0 ? '⚠️ Ανοιχτές βάρδιες: {{openShifts}}\n' : '') +
            '\nΚαλή εβδομάδα! 💪',
    },
};
